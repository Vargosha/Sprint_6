class HomePageLocators:
    COOKIES_ACCEPT_BUTTON = ("xpath", ".//button[@class='App_CookieButton__3cvqF']") # Кнопка Принятия Куки
    YANDEX_LOGO_BUTTON = ("xpath", ".//a[@class='Header_LogoYandex__3TSOI']") # Кнопка логотип Яндекс
    ...
    FAQ_ANSWER_FOUR = ("xpath", "(.//div[@class='accordion__panel'])[4]/p") # Панель Ответа на четвертый вопрос в FAQ
    FAQ_ANSWER_FIVE = ("xpath", "(.//div[@class='accordion__panel'])[5]/p") # Панель Ответа на пятый вопрос в FAQ
    FAQ_ANSWER_SIX = ("xpath", "(.//div[@class='accordion__panel'])[6]/p") # Панель Ответа на шестой вопрос в FAQ
    FAQ_ANSWER_SEVEN = ("xpath", "(.//div[@class='accordion__panel'])[7]/p") # Панель Ответа на седьмой вопрос в FAQ
    FAQ_ANSWER_EIGHT = ("xpath", "(.//div[@class='accordion__panel'])[8]/p") # Панель Ответа на восьмой вопрос в FAQ
